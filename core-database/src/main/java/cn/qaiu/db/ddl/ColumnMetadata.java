...
public class ColumnMetadata {
  ...
  // Java类型到SQL类型的映射
  private static final Map<Class<?>, String> JAVA_TO_SQL_TYPE_MAP =
  ...
  public ColumnMetadata(
      ...
      boolean nullable,
      String defaultValue,
      boolean defaultValueIsFunction,
  ...
  public String toColumnDefinition(JDBCType dbType, boolean includePrimaryKey) {
    ...
    if (defaultValue != null
        ...
        && !(autoIncrement && dbType == JDBCType.PostgreSQL)) {
  ...
  public boolean isDefaultValueIsFunction() {
    return defaultValueIsFunction;
  }

  public void setDefaultValueIsFunction(boolean defaultValueIsFunction) {
    this.defaultValueIsFunction = defaultValueIsFunction;
  }
