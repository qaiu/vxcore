...
/**
 * 基于Vert.x Pool的连接提供者 将Vert.x Pool适配为jOOQ的ConnectionProvider
 *
 * @author qaiu
 */
                ...
                try {
                  ...
                  if (pool.getClass().getName().contains("JDBCPool")) {
                    ...
                    java.lang.reflect.Field connectionField =
                        sqlConnection.getClass().getDeclaredField("connection");
                    ...
                    future.completeExceptionally(
                        new DataAccessException(
                            "Unsupported pool type: " + pool.getClass().getName()));
                  }
                } catch (Exception e) {
                  future.completeExceptionally(
                      new DataAccessException("Failed to get JDBC connection", e));
                }
              })
