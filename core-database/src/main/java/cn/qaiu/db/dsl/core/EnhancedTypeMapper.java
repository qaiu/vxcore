 ...
 * 增强的类型映射器
 *
 * <p>提供完善的类型转换功能，包括： - 数据库类型到Java类型的映射 - 日期时间格式处理 - 数值类型精度处理 - 字符串编码处理 - 自定义类型转换器
 *
...
public class EnhancedTypeMapper {
  ...
  private static final DateTimeFormatter ISO_DATETIME_WITH_MICROS_FORMATTER =
      DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss.SSSSSS");
  private static final DateTimeFormatter SQL_DATETIME_FORMATTER =
      DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
  private static final DateTimeFormatter SQL_DATETIME_WITH_MICROS_FORMATTER =
  ...
  public static <T> T convertToType(Object value, Class<T> targetType) {
    ...
    try {
      ...
      LOGGER.warn(
          "Cannot cast {} to {}", value.getClass().getSimpleName(), targetType.getSimpleName());
      return null;
    }
  }
