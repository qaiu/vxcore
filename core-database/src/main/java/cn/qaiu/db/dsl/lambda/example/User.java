...
public class User extends BaseEntity {
  ...
  public User(JsonObject json) {
    ...
    this.createTime =
        json.getString("createTime") != null
            ? LocalDateTime.parse(json.getString("createTime"))
            : null;
    this.updateTime =
        json.getString("updateTime") != null
            ? LocalDateTime.parse(json.getString("updateTime"))
            : null;
  }
