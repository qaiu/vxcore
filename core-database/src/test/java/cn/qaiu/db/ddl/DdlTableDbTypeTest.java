...
public class DdlTableDbTypeTest {
  ...
  void testMySQLDbTypeDetection() {
    // 创建测试类
    @DdlTable(value = "test_mysql_table", dbtype = "mysql", comment = "MySQL测试表")
  ...
  void testPostgreSQLDbTypeDetection() {
    // 创建测试类
    @DdlTable(value = "test_postgresql_table", dbtype = "postgresql", comment = "PostgreSQL测试表")
  ...
  void testH2DbTypeDetection() {
    // 创建测试类
    @DdlTable(value = "test_h2_table", dbtype = "h2", comment = "H2测试表")
    class TestH2Table {
      private Long id;
      private String name;
    }
  ...
  void testOracleDbTypeDetection() {
    // 创建测试类
    @DdlTable(value = "test_oracle_table", dbtype = "oracle", comment = "Oracle测试表")
  ...
  void testSqlServerDbTypeDetection() {
    // 创建测试类
    @DdlTable(value = "test_sqlserver_table", dbtype = "sqlserver", comment = "SQL Server测试表")
  ...
  void testEmptyDbTypeDefault() {
    // 创建测试类（不指定dbtype）
    @DdlTable(value = "test_default_table", comment = "默认数据库类型测试表")
  ...
  void testUnsupportedDbType() {
    // 创建测试类（使用不支持的dbtype）
    @DdlTable(value = "test_unsupported_table", dbtype = "unknown_db", comment = "不支持的数据库类型测试表")
  ...
  void testEnhancedCreateTableDbTypeDetection() {
    // 创建测试类
    @DdlTable(value = "test_enhanced_table", dbtype = "mysql", comment = "EnhancedCreateTable测试表")
