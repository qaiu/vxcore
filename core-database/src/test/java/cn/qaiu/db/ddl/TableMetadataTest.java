...
public class TableMetadataTest {
  ...
  public void testTableMetadataConstructor() {
    TableMetadata metadata =
        new TableMetadata(
            ...
            "utf8mb4_unicode_ci",
            "InnoDB",
            io.vertx.codegen.format.SnakeCase.INSTANCE,
            JDBCType.MySQL);
  ...
  public void testFromClassIgnoreFields() {
    class TestClass {
      private Integer id;
      private String name;
      @DdlIgnore private String ignoredField;
      @TableGenIgnore private String anotherIgnoredField;
  ...
  public void testFromClassWithRowMapped() {
    @io.vertx.sqlclient.templates.annotations.RowMapped(
        formatter = io.vertx.codegen.format.CamelCase.class)
    class TestClass {
