...
public class DeployTest {
    ...
    void testAutoDetectScanPathsWithExistingConfig() throws Exception {
        ...
        JsonObject config = new JsonObject()
            .put("scan", new io.vertx.core.json.JsonArray().add("cn.qaiu.test"));
    ...
    void testNewConfigFormatDetection() throws Exception {
        JsonObject newFormatConfig = new JsonObject()
    ...
    void testOldConfigFormatDetection() throws Exception {
        JsonObject oldFormatConfig = new JsonObject()
            .put("active", "dev")
        ...
        assertFalse(oldFormatConfig.containsKey("server") && oldFormatConfig.containsKey("datasources"), 
    ...
    void testStartMethodExists() throws Exception {
        // 验证start方法存在
        Method startMethod = Deploy.class.getMethod("start", String[].class, io.vertx.core.Handler.class);
