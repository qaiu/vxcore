...
/**
 * 依赖注入功能单元测试 测试Controller的自动依赖注入功能(使用普通类而非EventBus服务)
 *
...
class DependencyInjectionTest {
  ...
  public static class FieldInjectionController {
    ...
    @Inject SimpleService simpleService; // package-private for Dagger2
  ...
  public static class MultipleInjectionController {
    ...
    @Inject AnotherService anotherService; // package-private for Dagger2
  ...
  public static class NonServiceInjectionController {
    ...
    @Inject String someString; // 不是Service,应该保持null
        ...
        () -> {
          try {
            ...
            java.lang.reflect.Method method =
                RouterHandlerFactory.class.getDeclaredMethod(
    ...
    testContext.verify(
        () -> {
          try {
            ...
            Object instance =
                method.invoke(routerHandlerFactory, ConstructorInjectionController.class);
            assertNotNull(instance, "Controller实例不应为空");
    ...
    testContext.verify(
        () -> {
          try {
            ...
            Object instance =
                method.invoke(routerHandlerFactory, MultipleInjectionController.class);
            assertNotNull(instance, "Controller实例不应为空");
    ...
    testContext.verify(
        () -> {
          try {
            ...
            Object instance =
                method.invoke(routerHandlerFactory, NonServiceInjectionController.class);
  ...
  void testResolveService(VertxTestContext testContext) {
    testContext.verify(
        () -> {
          try {
            java.lang.reflect.Method method =
                RouterHandlerFactory.class.getDeclaredMethod("resolveService", Class.class);
            method.setAccessible(true);
