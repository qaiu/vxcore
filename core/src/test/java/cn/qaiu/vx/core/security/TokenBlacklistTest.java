...
class TokenBlacklistTest {
  ...
  void testExtractTokenIdentifierWithJti() {
    io.vertx.core.json.JsonObject claims =
        new io.vertx.core.json.JsonObject().put("jti", "unique-jwt-id-123").put("sub", "user-1");
  ...
  void testExtractTokenIdentifierWithoutJti() {
    io.vertx.core.json.JsonObject claims = new io.vertx.core.json.JsonObject().put("sub", "user-1");
    String token = "some-token";
