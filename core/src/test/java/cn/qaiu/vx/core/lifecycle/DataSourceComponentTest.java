...
public class DataSourceComponentTest {
  ...
  void testDataSourceRegistration(VertxTestContext testContext) {
    ...
    DataSourceProvider mockProvider =
        createMockDataSourceProviderWithPreset(java.util.List.of("default", "secondary"));
    dataSourceComponent.setDataSourceProvider(mockProvider);
  ...
  void testNoDataSourceConfiguration(VertxTestContext testContext) {
    JsonObject config =
        new JsonObject().put("server", new JsonObject().put("port", 8080).put("host", "0.0.0.0"));
  ...
  void testMultipleDataSourceConfiguration(VertxTestContext testContext) {
    ...
    // 设置模拟的DataSourceProvider
    DataSourceProvider mockProvider =
        createMockDataSourceProviderWithPreset(java.util.List.of("primary", "secondary", "log"));
    dataSourceComponent.setDataSourceProvider(mockProvider);
  ...
  private DataSourceProvider createMockDataSourceProviderWithPreset(
      java.util.List<String> presetNames) {
    return new DataSourceProvider() {
