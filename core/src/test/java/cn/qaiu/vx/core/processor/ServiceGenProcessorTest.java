...
public class ServiceGenProcessorTest {
  ...
  public void testProcessorGeneratesServiceClasses() throws IOException {
    ...
    File[] generatedFiles =
        mainGeneratedDir.listFiles(
            (dir, name) -> name.contains("Service") && name.endsWith(".java"));
    ...
    File processorClass =
        new File("target/classes/cn/qaiu/vx/core/processor/CustomServiceGenProcessor.class");
  ...
  public void testGeneratedFilesInMainProject() {
    ...
    if (mainGeneratedDir.exists()) {
      ...
      if (processorDir.exists()) {
        ...
        assertTrue(
            files != null && files.length > 0, "Should have generated files in processor package");
      ...
      if (entityDir.exists()) {
        ...
        assertTrue(
            files != null && files.length > 0, "Should have generated files in entity package");
      ...
      if (demoDir.exists()) {
        ...
        assertTrue(
            files != null && files.length > 0, "Should have generated files in demo package");
