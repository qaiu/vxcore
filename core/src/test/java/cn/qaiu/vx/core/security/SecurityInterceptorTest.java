...
public class SecurityInterceptorTest {
  ...
  void testExtractTokenFromHeader(Vertx vertx) throws Exception {
    Method method =
        SecurityInterceptor.class.getDeclaredMethod("extractToken", HttpServerRequest.class);
    method.setAccessible(true);
  ...
  void testVariousPathPatterns() throws Exception {
    ...
    Method requiresAuth =
        SecurityInterceptor.class.getDeclaredMethod("isPathRequiresAuth", String.class);
