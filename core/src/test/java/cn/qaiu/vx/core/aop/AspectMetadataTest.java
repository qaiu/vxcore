...
public class AspectMetadataTest {
  ...
  void testParseBeforeAdvice() {
    ...
    boolean hasBeforeAdvice = advices.stream().anyMatch(a -> a.getType() == AdviceType.BEFORE);
  ...
  void testParseAfterAdvice() {
    ...
    boolean hasAfterAdvice =
        metadata.getAdvices().stream().anyMatch(a -> a.getType() == AdviceType.AFTER);
  ...
  void testParseAroundAdvice() {
    ...
    boolean hasAroundAdvice =
        metadata.getAdvices().stream().anyMatch(a -> a.getType() == AdviceType.AROUND);
  ...
  void testParseAfterReturningAdvice() {
    ...
    AdviceMetadata advice =
        metadata.getAdvices().stream()
