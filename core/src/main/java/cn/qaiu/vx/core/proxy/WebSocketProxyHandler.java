...
/**
 * WebSocket代理处理器 实现WebSocket连接的双向代理转发
 *
 * @author QAIU
 */
public class WebSocketProxyHandler {
   ...
   */
  public void handleWebSocketProxy(
      ServerWebSocket clientSocket, String targetOrigin, String targetPath) {
    LOGGER.info(
        "Starting WebSocket proxy: {} -> {}:{}", clientSocket.path(), targetOrigin, targetPath);
    ...
    // 构建WebSocket连接选项
    WebSocketConnectOptions connectOptions =
