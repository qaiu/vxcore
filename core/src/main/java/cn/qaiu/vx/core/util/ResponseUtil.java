...
public class ResponseUtil {
   ...
   */
  public static void fireJsonObjectResponse(
      RoutingContext ctx, JsonObject jsonObject, int statusCode) {
    ctx.response()
   ...
   */
  public static void fireJsonObjectResponse(
      HttpServerResponse ctx, JsonObject jsonObject, int statusCode) {
   ...
   * @param <T> 数据类型
   */
  public static <T> void fireJsonResultResponse(
      RoutingContext ctx, JsonResult<T> jsonResult, int statusCode) {
