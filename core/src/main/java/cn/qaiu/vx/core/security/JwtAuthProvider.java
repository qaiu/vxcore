...
/**
 * JWT认证提供者
 * 封装Vert.x JWT Auth，提供Token生成和验证功能
 *
    ...
    public Future<Void> initialize() {
        ...
        return Future.future(promise -> {
            try {
                ...
                LOGGER.info("JWT Auth Provider initialized with algorithm: {}", config.getJwtAlgorithm());
                promise.complete();
            } catch (Exception e) {
    ...
    private JWTAuthOptions createJwtAuthOptions() throws Exception {
        ...
        if (algorithm.startsWith("HS")) {
            ...
            if (secret == null || secret.isEmpty()) {
                ...
                LOGGER.warn("JWT secret not configured, using auto-generated secret (not recommended for production)");
            }
            ...
            if (publicKeyPath != null && privateKeyPath != null) {
                ...
                // 生成临时密钥对
                LOGGER.warn("JWT keys not configured, generating temporary key pair (not recommended for production)");
