...
public class ConfigUtil {
    ...
    retriever
        ...
        .onFailure(
            err -> {
              ...
              promise.fail(new RuntimeException("读取配置文件失败: " + path, err));
              retriever.close();
            });
   ...
   * @return JsonObject的Future
   */
  public static synchronized Future<JsonObject> readYamlConfig(String path, Vertx vertx) {
   ...
   * @return JsonObject的Future
   */
  public static synchronized Future<JsonObject> readYamlConfig(String path) {
