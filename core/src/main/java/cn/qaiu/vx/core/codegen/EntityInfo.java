...
public class EntityInfo {
  ...
  public List<String> getFieldNames() {
    return fields.stream().map(FieldInfo::getFieldName).toList();
  }
  ...
  public List<String> getFieldTypes() {
    return fields.stream().map(FieldInfo::getFieldType).toList();
  }
  ...
  public List<FieldInfo> getFieldsByType(String fieldType) {
    return fields.stream().filter(field -> fieldType.equals(field.getFieldType())).toList();
  }
