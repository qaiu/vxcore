...
public @interface GenerateServiceGen {
  ...
  /**
   * Reference interface for entity classes to generate methods from When annotated on entity
   * classes, this specifies which generic interface methods should be generated (e.g.,
   * JooqDao.class)
   */
