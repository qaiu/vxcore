...
/**
 * 配置绑定器
 * 将JsonObject配置自动绑定到Java对象，使用策略模式处理不同类型
 *
...
public class ConfigBinder {
    ...
    private void registerDefaultStrategies() {
        ...
        registerStrategy(Integer.class, (value, targetType) -> {
        ...
        registerStrategy(int.class, (value, targetType) -> {
            if (value instanceof Number) return ((Number) value).intValue();
            if (value != null) {
        ...
        registerStrategy(Long.class, (value, targetType) -> {
        ...
        registerStrategy(Double.class, (value, targetType) -> {
