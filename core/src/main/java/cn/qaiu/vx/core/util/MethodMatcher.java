...
public class MethodMatcher {
  ...
  public static int calculateScore(
      Method method, Map<String, String> pathParams, MultiMap queryParams, boolean hasRequestBody) {
   ...
   * @return 是否完全匹配
   */
  public static boolean isFullyMatched(
      Method method, Map<String, String> pathParams, MultiMap queryParams, boolean hasRequestBody) {
    Parameter[] parameters = method.getParameters();
