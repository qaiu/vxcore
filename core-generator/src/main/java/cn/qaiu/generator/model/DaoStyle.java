...
/**
 * DAO 风格枚举 定义支持的三种 DAO 实现风格
 *
 * @author QAIU
 */
public enum DaoStyle {

  /** Vert.x SQL 风格 使用原生 SQL + 实体映射 实体类使用 @DdlTable, @DdlColumn 注解 */
  VERTX_SQL("vertx", "Vert.x SQL"),

  /** jOOQ 风格 使用 jOOQ DSL API 类型安全的 SQL 构建 */
  JOOQ("jooq", "jOOQ DSL"),

  /** Lambda 风格 VXCore 风格的 Lambda 查询 继承 LambdaDao，使用 Lambda 表达式 */
