    ...
    reader
        ...
        .onSuccess(
            tableInfo -> {
              ...
              // 检查主键
              ColumnInfo idColumn =
                  columns.stream().filter(ColumnInfo::isPrimaryKey).findFirst().orElse(null);
    ...
    reader
        ...
        .onSuccess(
            columns -> {
              ...
              assertTrue(
                  "VARCHAR".equals(nameColumn.getColumnType())
                      || "CHARACTER VARYING".equals(nameColumn.getColumnType()));
