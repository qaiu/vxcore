 ...
 * 服务生成处理器测试类
 *
 * <p>功能： 1. 测试重构后的注解处理器 2. 验证泛型参数解析 3. 验证服务接口生成 4. 验证服务实现类生成 5. 验证 ProxyGen 注解处理
 *
 * @author vxcore
 * @version 1.0
 */
public class ServiceGenProcessorTest {
  ...
  public void testProcessorGeneratesServiceClasses() throws IOException {
    ...
    JavaFileObject testEntityFile =
        new TestJavaFileObject("cn.qaiu.generator.processor.TestEntity", testEntitySource);
    ...
    // 验证生成的文件
    File generatedService =
        new File(
            generatedDir.getAbsolutePath(), "cn/qaiu/generator/processor/TestEntityService.java");
    // 注意：当 generateProxy = true 时，只生成 Service 接口，不生成 ServiceGen 实现类
    // File generatedServiceImpl = new File(generatedDir,
    // "cn/qaiu/generator/processor/TestEntityServiceGen.java");
  ...
  public void testGenericTypeAnalysis() throws IOException {
    ...
    JavaFileObject testEntityFile =
        new TestJavaFileObject("cn.qaiu.generator.processor.GenericTestEntity", testEntitySource);
    ...
    File generatedService =
        new File(
            ...
            "cn/qaiu/generator/processor/GenericTestEntityService.java");
    // 注意：当 generateProxy = true 时，只生成 Service 接口，不生成 ServiceGen 实现类
    // File generatedServiceImpl = new File(generatedDir,
    // "cn/qaiu/generator/processor/GenericTestEntityServiceGen.java");
  ...
  public void testProxyGenIntegration() throws IOException {
    ...
    JavaFileObject testEntityFile =
        new TestJavaFileObject("cn.qaiu.generator.processor.ProxyTestEntity", testEntitySource);
    ...
    File generatedService =
        new File(
            generatedDir.getAbsolutePath(),
            "cn/qaiu/generator/processor/ProxyTestEntityService.java");
    // 注意：当 generateProxy = true 时，只生成 Service 接口，不生成 ServiceGen 实现类
    // File generatedServiceImpl = new File(generatedDir,
    // "cn/qaiu/generator/processor/ProxyTestEntityServiceGen.java");
