...
public class OrderDetailServiceVertxEBProxy implements OrderDetailService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public OrderDetailServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public OrderDetailServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  @Override
  public io.vertx.core.Future<cn.qaiu.example.service.OrderWithDetailsAndUser> getOrderWithDetailsAndUser(java.lang.Long orderId){
    if (closed) return io.vertx.core.Future.failedFuture("Proxy is closed");
    JsonObject _json = new JsonObject();
    _json.put("orderId", orderId);

    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getOrderWithDetailsAndUser");
    _deliveryOptions.getHeaders().set("action", "getOrderWithDetailsAndUser");
    return _vertx.eventBus().<cn.qaiu.example.service.OrderWithDetailsAndUser>request(_address, _json, _deliveryOptions).map(msg -> {
      return msg.body();
    });
  }
  @Override
  public io.vertx.core.Future<io.vertx.core.json.JsonObject> getUserConsumptionAnalysis(java.lang.Long userId){
    if (closed) return io.vertx.core.Future.failedFuture("Proxy is closed");
    JsonObject _json = new JsonObject();
    _json.put("userId", userId);

    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getUserConsumptionAnalysis");
    _deliveryOptions.getHeaders().set("action", "getUserConsumptionAnalysis");
