...
public class UserServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      accessed();
      switch (action) {
        case "findActiveUsers": {
          service.findActiveUsers().onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "findByEmail": {
          service.findByEmail((java.lang.String)json.getValue("email")).onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "searchByName": {
          service.searchByName((java.lang.String)json.getValue("keyword")).onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "countUsers": {
          service.countUsers().onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "existsByEmail": {
          service.existsByEmail((java.lang.String)json.getValue("email")).onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "updateUserBalance": {
          service.updateUserBalance(json.getValue("userId") == null ? null : (json.getLong("userId").longValue()),
                                  (java.lang.String)json.getValue("balance")).onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "verifyUserEmail": {
          service.verifyUserEmail(json.getValue("userId") == null ? null : (json.getLong("userId").longValue())).onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "getUserStatistics": {
          service.getUserStatistics().onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "getUsersByAgeRange": {
          service.getUsersByAgeRange(json.getValue("minAge") == null ? null : (json.getLong("minAge").intValue()),
                                  json.getValue("maxAge") == null ? null : (json.getLong("maxAge").intValue())).onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "getById": {
