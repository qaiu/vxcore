...
public class ProductServiceVertxProxyHandler extends ProxyHandler {
  ...
  public ProductServiceVertxProxyHandler(Vertx vertx, ProductService service, boolean topLevel, long timeoutInSecond){
    this(vertx, service, true, timeoutInSecond, false);
  }

  public ProductServiceVertxProxyHandler(Vertx vertx, ProductService service, boolean topLevel, long timeoutSeconds, boolean includeDebugInfo) {
      this.vertx = vertx;
  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      accessed();
      switch (action) {
        case "findAvailableProducts": {
          service.findAvailableProducts().onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "findByPriceRange": {
          service.findByPriceRange((java.lang.String)json.getValue("minPrice"),
                                  (java.lang.String)json.getValue("maxPrice")).onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "findByCategory": {
          service.findByCategory(json.getValue("categoryId") == null ? null : (json.getLong("categoryId").longValue())).onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "searchProducts": {
          service.searchProducts((java.lang.String)json.getValue("keyword"),
        ...
        case "getHotProducts": {
          service.getHotProducts(json.getValue("limit") == null ? null : (json.getLong("limit").intValue())).onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "countProducts": {
          service.countProducts().onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "getAveragePrice": {
          service.getAveragePrice().onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "getById": {
