...
/**
 * 无参构造函数DAO示例 展示如何使用无参构造函数创建DAO，框架自动处理所有初始化
 *
...
public class NoArgConstructorDaoExamples {
  ...
  /** 最简单的用户DAO 连构造函数都没有，编译器自动生成无参构造函数 */
  ...
  /** 多数据源用户DAO 通过@DataSource注解指定数据源 */
  ...
  /** 演示无参构造函数的使用 展示如何创建和使用无参构造函数的DAO实例 */
  public static void demonstrateUsage() {
    ...
    LOGGER.info(
        "MultiDataSourceUserDao创建成功，实体类型: {}",
  ...
  /** 对比传统方式和无参构造函数方式 展示两种使用方式的差异和优势 */
