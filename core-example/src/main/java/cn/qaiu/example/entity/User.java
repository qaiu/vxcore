...
public class User extends BaseEntity {
  ...
  @DdlColumn(type = "VARCHAR", length = 255, nullable = false, comment = "密码(加密)")
  private String password;

  @DdlColumn(type = "INT", nullable = true, defaultValue = "0", comment = "年龄")
  private Integer age;

  @DdlColumn(type = "TEXT", nullable = true, comment = "个人简介")
  private String bio;
  ...
  @DdlColumn(type = "BOOLEAN", nullable = false, defaultValue = "false", comment = "邮箱是否验证")
  ...
  public User(JsonObject json) {
    ...
    this.status =
        json.getString("status") != null ? UserStatus.valueOf(json.getString("status")) : null;
    this.balance =
        json.getValue("balance") != null
            ? new BigDecimal(json.getValue("balance").toString())
            : null;
