...
/**
 * 订单详情实体类 演示 VXCore 框架的实体映射和数据库操作
 *
 * @author QAIU
 */
@DdlTable(
...
public class OrderDetail implements Serializable {
  ...
  @DdlColumn(type = "BIGINT", autoIncrement = true, nullable = false, comment = "主键ID")
  private Long id;

  @DdlColumn(type = "BIGINT", nullable = false, comment = "订单ID")
  private Long orderId;

  @DdlColumn(type = "BIGINT", nullable = false, comment = "商品ID")
  private Long productId;

  @DdlColumn(type = "VARCHAR(100)", nullable = false, comment = "商品名称")
  private String productName;

  @DdlColumn(type = "DECIMAL(10,2)", nullable = false, comment = "单价")
  private BigDecimal unitPrice;

  @DdlColumn(type = "INT", nullable = false, defaultValue = "1", comment = "数量")
  private Integer quantity;

  @DdlColumn(type = "DECIMAL(10,2)", nullable = false, comment = "小计")
  private BigDecimal subtotal;

  @DdlColumn(type = "VARCHAR(50)", comment = "分类")
  private String category;

  @DdlColumn(type = "TEXT", comment = "描述")
  ...
  public OrderDetail(JsonObject json) {
    ...
    this.createTime =
        json.getInstant("createTime") != null
            ? json.getInstant("createTime")
                .atZone(java.time.ZoneId.systemDefault())
                .toLocalDateTime()
            : null;
    this.updateTime =
        json.getInstant("updateTime") != null
            ? json.getInstant("updateTime")
                .atZone(java.time.ZoneId.systemDefault())
                .toLocalDateTime()
            : null;
  }
