...
public class DatabaseUtils {
  ...
  public static Future<Void> insertDemoUsers(UserDao userDao) {
    ...
    List<Future<User>> futures =
        demoUsers.stream().map(userDao::save).collect(java.util.stream.Collectors.toList());
  ...
  public static Future<Void> insertDemoProducts(ProductDao productDao) {
    ...
    List<Future<Product>> futures =
        demoProducts.stream().map(productDao::save).collect(java.util.stream.Collectors.toList());
