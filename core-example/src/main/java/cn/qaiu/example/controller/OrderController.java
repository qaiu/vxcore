...
public class OrderController implements BaseHttpApi {
  ...
  /** 根据订单号获取订单 GET /orders/search?orderNo={orderNo} */
  ...
  /** 获取产品的所有订单 GET /orders/product/{productId} */
  ...
  /** 根据状态获取订单 GET /orders/status/{status} */
  ...
  /** 获取订单统计信息 GET /orders/statistics */
  ...
  /** 获取用户订单统计 GET /orders/user/{userId}/statistics */
  ...
  /** 搜索订单 GET /orders/search?keyword={keyword} */
  @RouteMapping(value = "/orders/search", method = RouteMethod.GET)
