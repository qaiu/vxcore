...
public class ThreeLayerFrameworkTest {
  ...
  void testFrameworkStartup(VertxTestContext testContext) {
    testContext.verify(
        () -> {
          ...
          assertEquals(
              FrameworkLifecycleManager.LifecycleState.STARTED,
  ...
  void testDataSourceManagement(VertxTestContext testContext) {
    FrameworkLifecycleManager lifecycleManager = application.getLifecycleManager();
    cn.qaiu.vx.core.lifecycle.DataSourceComponent dataSourceComponent =
  ...
  void testServiceRegistration(VertxTestContext testContext) {
    FrameworkLifecycleManager lifecycleManager = application.getLifecycleManager();
    cn.qaiu.vx.core.lifecycle.ServiceRegistryComponent serviceComponent =
        lifecycleManager.getComponents().stream()
  ...
  void testRouterManagement(VertxTestContext testContext) {
    FrameworkLifecycleManager lifecycleManager = application.getLifecycleManager();
    cn.qaiu.vx.core.lifecycle.RouterComponent routerComponent =
        lifecycleManager.getComponents().stream()
    ...
    testContext.verify(
        () -> {
          ...
          cn.qaiu.vx.core.handlerfactory.RouterHandlerFactory routerHandlerFactory =
              routerComponent.getRouterHandlerFactory();
  ...
  void testFrameworkStateManagement(VertxTestContext testContext) {
    ...
    testContext.verify(
        () -> {
          ...
          assertEquals(FrameworkLifecycleManager.LifecycleState.STARTED, state, "框架状态应该是STARTED");
